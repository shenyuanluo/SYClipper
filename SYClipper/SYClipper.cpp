...
void SYClipper::setClipDataType(ClipDataType clipType)
{
    m_clipDataType = clipType;
}

#pragma mark -- 裁剪 YUV
int SYClipper::ClipYuv(unsigned char* srcYuv, unsigned int srcLen, unsigned char* dstYuv[0], unsigned int dstLen[0], ClipRect clipRect[0], unsigned int clipCount)
{
...
#pragma mark -- 通赔裁剪区域
ClipRect inline SYClipper::AdaptRect(ClipRect srcRect)
{
    ClipRect dstRect;
    // 适配 X
